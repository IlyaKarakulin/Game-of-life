...
public:
    Parse_input_data(Meta_data &m_data, int args, char **argv);
    ~Parse_input_data();
...
public:
    ...
    bool mode0_1(Field_calculation &game, Print_field &printer, Meta_data &m_data, string command, string output_file_name);
};
